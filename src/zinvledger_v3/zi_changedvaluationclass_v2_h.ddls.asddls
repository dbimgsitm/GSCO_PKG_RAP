...
define root view entity ZI_CHANGEDVALUATIONCLASS_V2_H
  as select from ztgsco0080h as History
  association [0..*] to ZI_CHANGEDVALUATIONCLASS_V2 as _Original on $projection.Refhead = _Original.Id
{
