...
define root view entity ZI_CHANGEDVALUATIONCLASS_V2
  as select from ztgsco0080 as Main
  association [*] to ZI_CHANGEDVALUATIONCLASS_V2_H as _History on $projection.Id = _History.Refhead
